...
The first time this test is run, elric creates a [snapshot file](https://github.com/facebook/elric/blob/main/examples/snapshot/__tests__/__snapshots__/link.test.js.snap) that looks like this:

...
_Note_: In TypeScript, when using `@types/elric` for example, you can declare the new `toBeWithinRange` matcher like this:
...
Check out [React Tree Snapshot Testing](https://elricjs.io/blog/2016/07/27/elric-14.html) for more information on snapshot testing.

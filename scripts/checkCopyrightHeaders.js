...
const CUSTOM_IGNORED_PATTERNS = [
  ...
  '^packages/elric-config/src/vendor/jsonlint\\.js$',
  '^packages/elric-diff/src/cleanupSemantic\\.ts$',
  '^packages/elric-haste-map/src/watchers/common\\.js$',
  '^packages/elric-haste-map/src/watchers/NodeWatcher\\.js$',
  '^packages/elric-haste-map/src/watchers/RecrawlWarning\\.js$',
